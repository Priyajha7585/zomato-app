  ...
  return (
    <div className='tab-options'>
        <div className='max-width options-wrapper'>
            {tabs.map((tab)=>{
                return(
                    <div className={`tab-item absolute-center cur-por ${activeTab===tab.name && "active-tab"}`} onClick={()=>{setActiveTab(tab.name)}}>
